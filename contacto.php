                    ...
                    <div class="col-md-12 col-12 mx-auto my-sm-5 text-center">
                        <div class="row">
                            <div class="col-md-7 col-12 px-0 mb-4">
                                <div class="">
                                <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1whpmshyYMjxCRplNEZ4rmNsYFgTYHO7t" class="barraGris" width="90%" height="690"></iframe>
                                    <!-- <iframe
                            ...
                            <!-- formulario-->
                            <div class="col-md-4 col-12" style="margin-top: 63px;">
