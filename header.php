...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet"
      href="<?php echo bloginfo('template_url' ); ?>//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
        ...
        <ul class="nav navbar-nav mx-auto mt-5 item1">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent" style="background: #220326;">
            <ul class="navbar-nav ml-auto text-black">
              ...
              <li class="nav-item">
                <a class="nav-link text-white ml-3" href="<?php echo esc_url( home_url('/') ); ?>pFrecuentes">PREGUNTAS
                  FRECUENTES</a>
              </li>
              <li class="nav-item">
