  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12 col-md-12 pr-md-0">
        ...
        <div class="imgCubus"
          style="max-height: 330px; background-image: url('<?php echo bloginfo('template_url' ); ?>/img/cubus.jpg');">
...
<section class="formulario">
  <div class="imgForm"
    style="height: 600px; background-image: url('<?php echo bloginfo('template_url' ); ?>/img/livingDeskAzul.jpg');">
