                    ...
                    <div class="col-12 col-md-12 px-0 text-center">
                        <div class="row">
                            <div class="col-md-4 px-0 d-flex align-items-center justify-content-center">
                                ...
                                <div class="px-0 d-flex justify-content-center align-items-center" id="heading196"
                                    rl="tab"></div>
                            </div>
                            ...
                            <div class="col-md-4 px-0 d-flex btn-efecto align-items-center justify-content-center">
                                ...
                                <div class="px-0 d-flex justify-content-center align-items-center" id="heading197"
                                    rl="tab"></div>
                            </div>
